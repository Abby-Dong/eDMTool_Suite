...
var COMPONENTS = [
            ...
            <table border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td class="hide-sm" style="padding: 0 8px;">
                  <a href="https://www.iotmart.com/s/campaigns?language=en_US" mc:edit="header_link1" style="font-size: 12px; text-decoration: none; font-family: Arial, sans-serif;" data-color="headerLinkColor">DEALS &amp; OFFERS</a>
                </td>
                <td style="padding: 0 8px;">
                  <a href="mailto:Service.iotmart@advantech.com" mc:edit="header_link2" style="font-size: 12px; text-decoration: none; font-family: Arial, sans-serif;" data-color="headerLinkColor">CONTACT US</a>
                </td>
              </tr>
            </table>
          </td>
  ...
  <tr>
    <td width="600" colspan="3" align="center" valign="middle" class="hero-v1-td"
      ...
      ${opts.showEyebrow !== false ? `<p mc:edit="hero_eyebrow"
         style="margin: 0 0 8px 0; font-size: 13px; font-family: Arial, sans-serif; letter-spacing: 4px; text-transform: uppercase;" data-color="bannerEyebrow">
        Exclusive Offer 2026
      </p>` : ''}
      <h1 mc:edit="hero_title" class="hero-v1-title"
          style="margin: 0 0 14px 0; font-size: 46px; font-weight: 900; font-family: Arial, sans-serif; line-height: 1.1;" data-color="bannerTitle">
        Industrial IoT<br/>Sale Is On
      </h1>
      ${opts.showSubtitle !== false ? `<p mc:edit="hero_subtitle"
         style="margin: 0; font-size: 16px; font-family: Arial, sans-serif;" data-color="bannerSubtitle">
  ...
  ${opts.showCta !== false ? `<tr>
    ...
    <td width="240" align="center" valign="middle" class="banner-cta-cell"
      ...
      <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="hero_cta"
         style="font-size: 16px; font-weight: bold; text-decoration: none; font-family: Arial, sans-serif;" data-color="bannerCtaText">
        Shop Now &rarr;
      </a>
    </td>
    <td width="180" class="banner-side" style="width: 180px; padding: 24px 0; font-size: 0; line-height: 0;" data-color="bannerBg"></td>
  ...
  <tr valign="middle">
    <td width="300" align="left" valign="middle" class="bv2-hero-td"
      ...
      ${opts.showEyebrow !== false ? `<p mc:edit="hero_eyebrow"
         style="margin: 0 0 10px 0; font-size: 11px; font-family: Arial, sans-serif; letter-spacing: 4px; text-transform: uppercase;" data-color="banner2Eyebrow">
        Exclusive Offer 2026
      </p>` : ''}
      ...
      ${opts.showCta !== false ? `<table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td style="padding: 12px 24px;" data-color="banner2CtaBg">
            <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="hero_cta"
               style="font-size: 14px; font-weight: bold; text-decoration: none; font-family: Arial, sans-serif;" data-color="banner2CtaText">
              Shop Now &rarr;
            </a>
          </td>
        </tr>
                  ...
                  ${opts.showBadges !== false ? `<table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-bottom: 8px;">
                    <tr>
                      <td data-color="prodBadgeBg" style="padding: 3px 8px; line-height: 1;">
                        <span mc:edit="product1_badge1" style="font-size: 10px; line-height: 1; font-family: Arial, sans-serif; font-weight: bold; letter-spacing: 1px;" data-color="prodBadgeText">SALE</span>
                      </td>
                      ...
                      <td data-color="prodBadge2Bg" style="padding: 3px 8px; line-height: 1;" data-border-color="prodBadgeBorder">
                        <span mc:edit="product1_badge2" style="font-size: 10px; line-height: 1; font-family: Arial, sans-serif; font-weight: bold;" data-color="prodBadge2Text">10% OFF</span>
                      </td>
                    </tr>
                  </table>` : ''}
                  <p mc:edit="product1_name" style="margin: 0 0 4px 0; font-size: 14px; font-weight: bold; font-family: Arial, sans-serif;" data-color="prodName">AIR-030-B90A1</p>
                  <p mc:edit="product1_desc" style="margin: 0 0 10px 0; font-size: 12px; font-family: Arial, sans-serif;" data-color="prodDesc">NVIDIA® Jetson AGX Orin™ AI Inference System</p>
              ...
              <tr>
                <td width="261" align="center" class="card-cta" style="width: 261px; padding: 14px 0;" data-color="prodCtaBg">
                  <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="product1_cta"
                     style="display: block; font-size: 13px; font-weight: bold; text-decoration: none; font-family: Arial, sans-serif;" data-color="prodCtaText">
              ...
              <tr>
                <td width="261" align="center" class="card-body" style="width: 261px; padding: 16px 12px 12px 12px;">
                  ${opts.showBadges !== false ? `<table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-bottom: 8px;">
                    <tr>
                      <td data-color="prodBadgeBg" style="padding: 3px 8px; line-height: 1;">
                        <span mc:edit="product2_badge1" style="font-size: 10px; line-height: 1; font-family: Arial, sans-serif; font-weight: bold; letter-spacing: 1px;" data-color="prodBadgeText">SALE</span>
                      </td>
                      <td width="6" style="width: 6px;"></td>
                      <td data-color="prodBadge2Bg" style="padding: 3px 8px; line-height: 1;" data-border-color="prodBadgeBorder">
                        <span mc:edit="product2_badge2" style="font-size: 10px; line-height: 1; font-family: Arial, sans-serif; font-weight: bold;" data-color="prodBadge2Text">10% OFF</span>
                      </td>
                    </tr>
                  </table>` : ''}
                  <p mc:edit="product2_name" style="margin: 0 0 4px 0; font-size: 14px; font-weight: bold; font-family: Arial, sans-serif;" data-color="prodName">AIR-030-S30A1</p>
                  <p mc:edit="product2_desc" style="margin: 0 0 10px 0; font-size: 12px; font-family: Arial, sans-serif;" data-color="prodDesc">NVIDIA® Jetson AGX Orin™ AI Inference System</p>
                  <table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-bottom: 12px;">
                    <tr>
              ...
              <tr>
                <td width="261" align="center" class="card-body" style="width: 261px; padding: 16px 12px 12px 12px;">
                  ${opts.showBadges !== false ? `<table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-bottom: 8px;">
                    <tr>
                      <td data-color="prodBadgeBg" style="padding: 3px 8px; line-height: 1;">
                        <span mc:edit="product3_badge1" style="font-size: 10px; line-height: 1; font-family: Arial, sans-serif; font-weight: bold; letter-spacing: 1px;" data-color="prodBadgeText">SALE</span>
                      </td>
                      <td width="6" style="width: 6px;"></td>
                      <td data-color="prodBadge2Bg" style="padding: 3px 8px; line-height: 1;" data-border-color="prodBadgeBorder">
                        <span mc:edit="product3_badge2" style="font-size: 10px; line-height: 1; font-family: Arial, sans-serif; font-weight: bold;" data-color="prodBadge2Text">10% OFF</span>
                      </td>
                    </tr>
                  </table>` : ''}
                  <p mc:edit="product3_name" style="margin: 0 0 4px 0; font-size: 14px; font-weight: bold; font-family: Arial, sans-serif;" data-color="prodName">AIR-020X-S9A1</p>
                  <p mc:edit="product3_desc" style="margin: 0 0 10px 0; font-size: 12px; font-family: Arial, sans-serif;" data-color="prodDesc">NVIDIA® Jetson™ Xavier NX AI Inference System</p>
                  <table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-bottom: 12px;">
                    <tr>
              ...
              <tr>
                <td width="261" align="center" class="card-body" style="width: 261px; padding: 16px 12px 12px 12px;">
                  ${opts.showBadges !== false ? `<table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-bottom: 8px;">
                    <tr>
                      <td data-color="prodBadgeBg" style="padding: 3px 8px; line-height: 1;">
                        <span mc:edit="product4_badge1" style="font-size: 10px; line-height: 1; font-family: Arial, sans-serif; font-weight: bold; letter-spacing: 1px;" data-color="prodBadgeText">SALE</span>
                      </td>
                      <td width="6" style="width: 6px;"></td>
                      <td data-color="prodBadge2Bg" style="padding: 3px 8px; line-height: 1;" data-border-color="prodBadgeBorder">
                        <span mc:edit="product4_badge2" style="font-size: 10px; line-height: 1; font-family: Arial, sans-serif; font-weight: bold;" data-color="prodBadge2Text">10% OFF</span>
                      </td>
                    </tr>
                  </table>` : ''}
                  <p mc:edit="product4_name" style="margin: 0 0 4px 0; font-size: 14px; font-weight: bold; font-family: Arial, sans-serif;" data-color="prodName">ARK-1124C-S1A3</p>
                  <p mc:edit="product4_desc" style="margin: 0 0 10px 0; font-size: 12px; font-family: Arial, sans-serif;" data-color="prodDesc">Intel® Celeron™ Fanless Edge Computer System</p>
                  <table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-bottom: 12px;">
                    <tr>
          ...
          <td width="180" align="center" valign="top" class="col-3" style="padding: 0 4px 0 0; width: 180px;">
            <table border="0" cellpadding="0" cellspacing="0" width="176" class="product-card"
                ...
                ${opts.showBadges !== false ? `<table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-bottom: 8px;">
                  <tr>
                    <td data-color="prod2BadgeBg" style="padding: 3px 6px; line-height: 1;">
                      <span mc:edit="product1_badge1" style="font-size: 9px; line-height: 1; font-family: Arial, sans-serif; font-weight: bold; letter-spacing: 1px;" data-color="prod2BadgeText">SALE</span>
                    </td>
                    ...
                    <td data-color="prod2Badge2Bg" style="padding: 3px 6px; line-height: 1;" data-border-color="prod2BadgeBorder">
                      <span mc:edit="product1_badge2" style="font-size: 9px; line-height: 1; font-family: Arial, sans-serif; font-weight: bold;" data-color="prod2Badge2Text">10% OFF</span>
                    </td>
                  </tr>
                </table>` : ''}
                <p mc:edit="product1_name" style="margin: 0 0 4px 0; font-size: 13px; font-weight: bold; font-family: Arial, sans-serif;" data-color="prod2Name">AIR-020X-S9A1</p>
                <p mc:edit="product1_desc" style="margin: 0 0 8px 0; font-size: 11px; font-family: Arial, sans-serif;" data-color="prod2Desc">NVIDIA® Jetson™ Xavier NX AI Inference System</p>
              ...
              <tr><td width="174" align="center" class="card-cta" style="width: 174px; padding: 12px 0;" data-color="prod2CtaBg">
                <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="product1_cta" style="display: block; font-size: 12px; font-weight: bold; text-decoration: none; font-family: Arial, sans-serif;" data-color="prod2CtaText"><span data-color="prod2CtaText">Shop Now &rarr;</span></a>
              </td></tr>
            </table>
          </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="176" class="product-card"
              ...
              <tr><td width="174" align="center" class="card-body" style="width: 174px; padding: 12px 8px 8px 8px;">
                ${opts.showBadges !== false ? `<table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-bottom: 8px;">
                  <tr>
                    <td data-color="prod2BadgeBg" style="padding: 3px 6px; line-height: 1;">
                      <span mc:edit="product2_badge1" style="font-size: 9px; line-height: 1; font-family: Arial, sans-serif; font-weight: bold; letter-spacing: 1px;" data-color="prod2BadgeText">SALE</span>
                    </td>
                    <td width="4" style="width: 4px;"></td>
                    <td data-color="prod2Badge2Bg" style="padding: 3px 6px; line-height: 1;" data-border-color="prod2BadgeBorder">
                      <span mc:edit="product2_badge2" style="font-size: 9px; line-height: 1; font-family: Arial, sans-serif; font-weight: bold;" data-color="prod2Badge2Text">10% OFF</span>
                    </td>
                  </tr>
                </table>` : ''}
                <p mc:edit="product2_name" style="margin: 0 0 4px 0; font-size: 13px; font-weight: bold; font-family: Arial, sans-serif;" data-color="prod2Name">ARK-1124C-S1A3</p>
                <p mc:edit="product2_desc" style="margin: 0 0 8px 0; font-size: 11px; font-family: Arial, sans-serif;" data-color="prod2Desc">Intel® Celeron™ Fanless Edge Computer System</p>
                <table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-bottom: 10px;">
                  <tr>
              ...
              <tr><td width="174" align="center" class="card-cta" style="width: 174px; padding: 12px 0;" data-color="prod2CtaBg">
                <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="product2_cta" style="display: block; font-size: 12px; font-weight: bold; text-decoration: none; font-family: Arial, sans-serif;" data-color="prod2CtaText"><span data-color="prod2CtaText">Shop Now &rarr;</span></a>
              </td></tr>
            </table>
          </td>
          <td width="10" class="col-gap" style="width: 10px;"></td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="176" class="product-card"
              ...
              <tr><td width="174" align="center" class="card-body" style="width: 174px; padding: 12px 8px 8px 8px;">
                ${opts.showBadges !== false ? `<table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-bottom: 8px;">
                  <tr>
                    <td data-color="prod2BadgeBg" style="padding: 3px 6px; line-height: 1;">
                      <span mc:edit="product3_badge1" style="font-size: 9px; line-height: 1; font-family: Arial, sans-serif; font-weight: bold; letter-spacing: 1px;" data-color="prod2BadgeText">SALE</span>
                    </td>
                    <td width="4" style="width: 4px;"></td>
                    <td data-color="prod2Badge2Bg" style="padding: 3px 6px; line-height: 1;" data-border-color="prod2BadgeBorder">
                      <span mc:edit="product3_badge2" style="font-size: 9px; line-height: 1; font-family: Arial, sans-serif; font-weight: bold;" data-color="prod2Badge2Text">10% OFF</span>
                    </td>
                  </tr>
                </table>` : ''}
                <p mc:edit="product3_name" style="margin: 0 0 4px 0; font-size: 13px; font-weight: bold; font-family: Arial, sans-serif;" data-color="prod2Name">AIR-030-B90A1</p>
                <p mc:edit="product3_desc" style="margin: 0 0 8px 0; font-size: 11px; font-family: Arial, sans-serif;" data-color="prod2Desc">NVIDIA® Jetson AGX Orin™ AI Inference System</p>
                <table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-bottom: 10px;">
                  <tr>
              ...
              <tr><td width="174" align="center" class="card-cta" style="width: 174px; padding: 12px 0;" data-color="prod2CtaBg">
                <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="product3_cta" style="display: block; font-size: 12px; font-weight: bold; text-decoration: none; font-family: Arial, sans-serif;" data-color="prod2CtaText"><span data-color="prod2CtaText">Shop Now &rarr;</span></a>
              </td></tr>
            </table>
          </td>
        </tr>
      ...
      ${opts.showCta !== false ? `<table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td style="padding: 12px 28px;" data-color="splitCtaBg">
            <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="split_cta" style="font-size: 14px; font-weight: bold; text-decoration: none; font-family: Arial, sans-serif;" data-color="splitCtaText">Learn More &rarr;</a>
          </td>
        </tr>
      </table>` : ''}
    </td>
      ...
      ${opts.showCta !== false ? `<table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td style="padding: 12px 28px;" data-color="split2CtaBg">
            <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="split2_cta" style="font-size: 14px; font-weight: bold; text-decoration: none; font-family: Arial, sans-serif;" data-color="split2CtaText">Learn More &rarr;</a>
          </td>
        </tr>
      </table>` : ''}
    </td>
  ...
  <tr>
    <td width="600" align="center" valign="middle" style="width: 600px; padding: 32px 30px;">
      ${opts.showEyebrow !== false ? `<p mc:edit="coupon_eyebrow" style="margin: 0 0 6px 0; font-size: 12px; font-family: Arial, sans-serif; letter-spacing: 2px; text-transform: uppercase;" data-color="couponEyebrow">Exclusive Promo Code</p>` : ''}
      <p mc:edit="coupon_headline" style="margin: 0 0 16px 0; font-size: 20px; font-weight: bold; font-family: Arial, sans-serif;" data-color="couponHeadline">Save <span data-color="couponAccent">$50</span> on Your Order</p>
      ...
      ${opts.showTerms !== false ? `<p mc:edit="coupon_terms" style="margin: 12px 0 0 0; font-size: 11px; font-family: Arial, sans-serif;" data-color="couponTerms">* Valid on orders over $300. Single use per account. Cannot be combined with other offers.</p>` : ''}
    </td>
  </tr>
</table>`,
    colorMap: [
  ...
  ${opts.showEyebrow !== false ? `<tr><td align="center" style="padding: 28px 20px 4px 20px;">
    <p mc:edit="cpn1_eyebrow" style="margin: 0; font-size: 11px; font-family: Arial, sans-serif; letter-spacing: 3px; text-transform: uppercase;" data-color="cpn1Eyebrow">Limited Time Offer</p>
  </td></tr>` : ''}
  <tr><td align="center" style="padding: ${opts.showEyebrow !== false ? '0' : '28px'} 20px 6px 20px;">
    <h2 mc:edit="cpn1_title" style="margin: 0; font-size: 24px; font-weight: bold; font-family: Arial, sans-serif;" data-color="cpn1Title">Exclusive Savings Await</h2>
  </td></tr>
  <tr><td align="center" style="padding: 0 20px 20px 20px;">
    <p mc:edit="cpn1_subtitle" style="margin: 0; font-size: 13px; font-family: Arial, sans-serif;" data-color="cpn1Subtitle">Save big on your next purchase with this special coupon</p>
  </td></tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="560" class="cs-card" style="width: 560px; border-collapse: collapse;">
      <tr>
        ${opts.showImage !== false ? `<td class="cs-img" width="200" valign="middle" align="center" style="width: 200px; height: 200px; background-image: url('${_cimg}'); background-size: cover; background-position: center; text-align: center;" data-color="cpn1ImgBg">
          ${opts.showImgText !== false ? `<p mc:edit="cpn1_imgLabel" style="margin: 0 0 6px 0; font-size: 11px; font-weight: 400; font-family: Arial, sans-serif; letter-spacing: 2px; text-transform: uppercase; line-height: 1.4; color: #ffffff; text-align: center;">LIMITED TIME OFFER</p>
          <p mc:edit="cpn1_imgTitle" style="margin: 0; font-size: 48px; font-weight: bold; font-family: Arial, sans-serif; line-height: 1.1; color: #ffffff; text-align: center;">$50 OFF</p>` : ''}
        </td>` : ''}
        <td class="cs-text" width="${opts.showImage !== false ? '360' : '560'}" valign="top" style="width: ${opts.showImage !== false ? 360 : 560}px; background-color: #ffffff;">
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="width: 100%; border-collapse: collapse;">
            <tr><td align="left" class="cs-text-cell" style="padding: 20px 20px 16px 20px; background-color: #ffffff;">
              <p mc:edit="cpn1_headline" style="margin: 0; font-size: 11px; font-weight: 400; font-family: Arial, sans-serif; letter-spacing: 2px; text-transform: uppercase; line-height: 1.4;" data-color="cpn1Headline">GET $50.00 OFF YOUR NEXT FULL PRICE PURCHASE!</p>
            </td></tr>
            ...
            <tr><td align="left" class="cs-text-cell" style="padding: 16px 20px ${opts.showCta !== false ? '6px' : '20px'} 20px; background-color: #ffffff;">
              <p mc:edit="cpn1_amount" style="margin: 0 0 4px 0; font-size: 28px; font-weight: bold; font-family: Arial, sans-serif; line-height: 1.1;" data-color="cpn1Amount">$50.00</p>
              ${opts.showValidity !== false ? `<p mc:edit="cpn1_validity" style="margin: 0; font-size: 11px; font-family: Arial, sans-serif;" data-color="cpn1Validity">Valid through 2026/7/31</p>` : ''}
            </td></tr>
            ${opts.showCta !== false ? `<tr><td align="right" class="cs-cta-cell" style="padding: 8px 20px 20px 20px; background-color: #ffffff;">
              <table border="0" cellpadding="0" cellspacing="0" align="right" class="cs-cta-table">
                <tr><td align="center" style="padding: 10px 20px;" data-color="cpn1CtaBg">
                  <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="cpn1_cta" style="font-family: Arial, sans-serif; font-size: 13px; font-weight: bold; text-decoration: none; white-space: nowrap; color: #ffffff;">Save Pass</a>
                </td></tr>
              </table>
            </td></tr>` : ''}
          </table>
  ...
  ${opts.showEyebrow !== false ? `<tr><td align="center" style="padding: 28px 20px 4px 20px;">
    <p mc:edit="coupon_eyebrow" style="margin: 0; font-size: 11px; font-family: Arial, sans-serif; letter-spacing: 3px; text-transform: uppercase;" data-color="coupon2Eyebrow">Limited Time Offer</p>
  </td></tr>` : ''}
  <tr><td align="center" style="padding: ${opts.showEyebrow !== false ? '0' : '28px'} 20px 6px 20px;">
    <h2 mc:edit="coupon_title" style="margin: 0; font-size: 24px; font-weight: bold; font-family: Arial, sans-serif;" data-color="coupon2Title">Exclusive Savings Await</h2>
  </td></tr>
  <tr><td align="center" style="padding: 0 20px 20px 20px;">
    <p mc:edit="coupon_subtitle" style="margin: 0; font-size: 13px; font-family: Arial, sans-serif;" data-color="coupon2Subtitle">Save big on your next purchase with these special coupons</p>
  </td></tr>
  <tr><td align="center" style="padding: 0 20px 28px 20px;">
        ...
        <td class="cd-col" width="269" valign="top" align="center" style="width: 269px; vertical-align: top;">
          <table border="0" cellpadding="0" cellspacing="0" width="269" class="cd-card" style="width: 269px; border-collapse: collapse;">
            <tr><td align="center" valign="middle" class="cd-card-img" height="202" style="height: 202px;${opts.showImage !== false ? ` background-image: url('${_cimg}'); background-size: cover; background-position: center;` : ''}" data-color="coupon2Card1ImgBg">
              ${opts.showImgText !== false ? `<p mc:edit="coupon1_imgLabel" style="margin: 0 0 6px 0; font-size: 11px; font-weight: 400; font-family: Arial, sans-serif; letter-spacing: 2px; text-transform: uppercase; line-height: 1.4; color: #ffffff;">LIMITED TIME OFFER</p>
              <p mc:edit="coupon1_imgTitle" style="margin: 0; font-size: 48px; font-weight: bold; font-family: Arial, sans-serif; line-height: 1.1; color: #ffffff;">$50 OFF</p>` : ''}
            </td></tr>
            <tr><td align="center" style="padding: 20px 20px 16px 20px; background-color: #ffffff;">
              <p mc:edit="coupon1_headline" style="margin: 0; font-size: 11px; font-weight: 400; font-family: Arial, sans-serif; letter-spacing: 2px; text-transform: uppercase; line-height: 1.4;" data-color="coupon2Headline">GET $50.00 OFF YOUR NEXT FULL PRICE PURCHASE!</p>
            </td></tr>
            ...
            <tr><td style="padding: 16px 20px ${opts.showCta !== false ? '6px' : '20px'} 20px; background-color: #ffffff;">
              <p mc:edit="coupon1_amount" style="margin: 0 0 4px 0; font-size: 28px; font-weight: bold; font-family: Arial, sans-serif; line-height: 1.1;" data-color="coupon2Amount">$50.00</p>
              ${opts.showValidity !== false ? `<p mc:edit="coupon1_validity" style="margin: 0; font-size: 11px; font-family: Arial, sans-serif;" data-color="coupon2Validity">Valid through 2026/7/31</p>` : ''}
            </td></tr>
            ${opts.showCta !== false ? `<tr><td align="right" style="padding: 8px 20px 20px 20px; background-color: #ffffff;">
              <table border="0" cellpadding="0" cellspacing="0" align="right">
                <tr><td align="center" style="padding: 10px 20px;" data-color="coupon2CtaBg">
                  <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="coupon1_cta" style="font-family: Arial, sans-serif; font-size: 13px; font-weight: bold; text-decoration: none; white-space: nowrap; color: #ffffff;">Save Pass</a>
                </td></tr>
              </table>
            </td></tr>` : ''}
          </table>
        ...
        <td class="cd-col" width="269" valign="top" align="center" style="width: 269px; vertical-align: top;">
          <table border="0" cellpadding="0" cellspacing="0" width="269" class="cd-card" style="width: 269px; border-collapse: collapse;">
            <tr><td align="center" valign="middle" class="cd-card-img" height="202" style="height: 202px;${opts.showImage !== false ? ` background-image: url('${_cimg}'); background-size: cover; background-position: center;` : ''}" data-color="coupon2Card2ImgBg">
              ${opts.showImgText !== false ? `<p mc:edit="coupon2_imgLabel" style="margin: 0 0 6px 0; font-size: 11px; font-weight: 400; font-family: Arial, sans-serif; letter-spacing: 2px; text-transform: uppercase; line-height: 1.4; color: #ffffff;">SPECIAL DEAL</p>
              <p mc:edit="coupon2_imgTitle" style="margin: 0; font-size: 48px; font-weight: bold; font-family: Arial, sans-serif; line-height: 1.1; color: #ffffff;">$30 OFF</p>` : ''}
            </td></tr>
            <tr><td align="center" style="padding: 20px 20px 16px 20px; background-color: #ffffff;">
              <p mc:edit="coupon2_headline" style="margin: 0; font-size: 11px; font-weight: 400; font-family: Arial, sans-serif; letter-spacing: 2px; text-transform: uppercase; line-height: 1.4;" data-color="coupon2Headline">GET $30.00 OFF YOUR NEXT FULL PRICE PURCHASE!</p>
            </td></tr>
            <tr><td style="padding: 0; height: 24px; font-size: 0; line-height: 0; background-color: #ffffff;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="width: 100%; border-collapse: collapse;">
                <tr>
            ...
            <tr><td style="padding: 16px 20px ${opts.showCta !== false ? '6px' : '20px'} 20px; background-color: #ffffff;">
              <p mc:edit="coupon2_amount" style="margin: 0 0 4px 0; font-size: 28px; font-weight: bold; font-family: Arial, sans-serif; line-height: 1.1;" data-color="coupon2Amount">$30.00</p>
              ${opts.showValidity !== false ? `<p mc:edit="coupon2_validity" style="margin: 0; font-size: 11px; font-family: Arial, sans-serif;" data-color="coupon2Validity">Valid through 2026/7/31</p>` : ''}
            </td></tr>
            ${opts.showCta !== false ? `<tr><td align="right" style="padding: 8px 20px 20px 20px; background-color: #ffffff;">
              <table border="0" cellpadding="0" cellspacing="0" align="right">
                <tr><td align="center" style="padding: 10px 20px;" data-color="coupon2CtaBg">
                  <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="coupon2_cta" style="font-family: Arial, sans-serif; font-size: 13px; font-weight: bold; text-decoration: none; white-space: nowrap; color: #ffffff;">Save Pass</a>
                </td></tr>
              </table>
            </td></tr>` : ''}
          </table>
  ...
  ${opts.showEyebrow !== false ? `<tr><td align="center" style="padding: 28px 20px 16px 20px;">
    <p mc:edit="promo_eyebrow" style="margin: 0; font-size: 12px; font-family: Arial, sans-serif; letter-spacing: 2px; text-transform: uppercase;" data-color="promo2Eyebrow">Exclusive Promo Codes</p>
  </td></tr>` : ''}
  <tr><td align="center" style="padding: 0 20px 28px 20px;">
    <table border="0" cellpadding="0" cellspacing="0" width="560" class="product-grid" style="width: 560px;">
      <tr>
        <td class="col-2" width="269" valign="top" align="left" style="width: 269px; vertical-align: top;" data-border-color="promo2Color1Border">
          <table border="0" cellpadding="0" cellspacing="0" width="267" class="product-grid promo-card" style="width: 267px; border-collapse: collapse;">
            <tr><td align="center" style="padding: 10px 16px;" data-color="promo2Color1Bg">
              <p mc:edit="promo1_tag" style="margin: 0; font-size: 10px; font-family: Arial, sans-serif; letter-spacing: 1px; text-transform: uppercase; font-weight: bold; color: #ffffff;">New Customer Offer</p>
            </td></tr>
            <tr><td align="center" style="padding: 16px;" data-color="promo2Color1BodyBg">
              <p mc:edit="promo1_headline" style="margin: 0 0 8px 0; font-size: 14px; font-weight: bold; font-family: Arial, sans-serif; color: #ffffff;">Save <span data-color="promo2Color1Text">$50</span> on First Order</p>
              <table border="0" cellpadding="0" cellspacing="0" align="center">
            ...
            <tr><td align="center" style="padding: 12px 16px;">
              <table border="0" cellpadding="0" cellspacing="0" align="center">
                <tr><td align="center" style="padding: 8px 20px;" data-color="promo2Color1Bg">
                  <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="promo1_cta" style="font-family: Arial, sans-serif; font-size: 12px; font-weight: bold; text-decoration: none; color: #ffffff;">Shop Now</a>
                </td></tr>
              </table>
            </td></tr>
          </table>
        ...
        <td class="col-2" width="269" valign="top" align="left" style="width: 269px; vertical-align: top;" data-border-color="promo2Color2Border">
          <table border="0" cellpadding="0" cellspacing="0" width="267" class="product-grid promo-card" style="width: 267px; border-collapse: collapse;">
            <tr><td align="center" style="padding: 10px 16px;" data-color="promo2Color2Bg">
              <p mc:edit="promo2_tag" style="margin: 0; font-size: 10px; font-family: Arial, sans-serif; letter-spacing: 1px; text-transform: uppercase; font-weight: bold; color: #ffffff;">Returning Member Deal</p>
            </td></tr>
            <tr><td align="center" style="padding: 16px;" data-color="promo2Color2BodyBg">
              <p mc:edit="promo2_headline" style="margin: 0 0 8px 0; font-size: 14px; font-weight: bold; font-family: Arial, sans-serif; color: #ffffff;">Save <span data-color="promo2Color2Text">$30</span> on Next Order</p>
              <table border="0" cellpadding="0" cellspacing="0" align="center">
            ...
            <tr><td align="center" style="padding: 12px 16px;">
              <table border="0" cellpadding="0" cellspacing="0" align="center">
                <tr><td align="center" style="padding: 8px 20px;" data-color="promo2Color2Bg">
                  <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="promo2_cta" style="font-family: Arial, sans-serif; font-size: 12px; font-weight: bold; text-decoration: none; color: #ffffff;">Shop Now</a>
                </td></tr>
              </table>
            </td></tr>
          </table>
    ...
    <td width="600" align="center" valign="top" style="width: 600px; padding: 36px 20px;" data-color="actBg">
      ${opts.showEyebrow !== false ? `<table border="0" cellpadding="0" cellspacing="0" width="560" class="split-table" style="width: 560px;">
        <tr><td align="center" style="width: 560px; padding: 0 0 24px 0;" width="560">
          <p mc:edit="other_eyebrow" style="margin: 0 0 4px 0; font-size: 12px; font-family: Arial, sans-serif; letter-spacing: 2px; text-transform: uppercase; font-weight: bold;" data-color="actEyebrow">More Promotions</p>
          <p mc:edit="other_headline" style="margin: 0; font-size: 22px; font-weight: bold; font-family: Arial, sans-serif;" data-color="actHeadline">Other Activities</p>
        </td></tr>
      </table>` : ''}
          ...
          <td align="left" valign="top" class="col-3" style="width: 180px; padding: 0 4px 0 0;" width="180">
            <table border="0" cellpadding="0" cellspacing="0" width="176" class="activity-card" style="width: 176px; border: 1px solid #e0e6f0;" data-color="actCardBg">
              ...
              <tr><td align="left" class="card-body" style="width: 176px; padding: 16px 16px 14px 16px;" width="176">
                ...
                <p mc:edit="activity1_title" style="margin: 0 0 6px 0; font-size: 14px; font-weight: bold; font-family: Arial, sans-serif;" data-color="actTitle">Edge AI System</p>
                <p mc:edit="activity1_desc" style="margin: 0 0 14px 0; font-size: 12px; font-family: Arial, sans-serif; line-height: 1.6;" data-color="actDesc">Get <strong>10% off</strong> on selected Edge AI Systems. Accelerate your AI at the edge deployment today.</p>
                ${opts.showCta !== false ? `<table border="0" cellpadding="0" cellspacing="0">
                  <tr><td style="padding: 8px 16px;" data-color="actCtaBg">
                    <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="activity1_cta" style="font-size: 11px; font-weight: bold; text-decoration: none; font-family: Arial, sans-serif;" data-color="actCtaText">Shop Now &rarr;</a>
                  </td></tr>
                </table>` : ''}
              </td></tr>
            </table>
          ...
          <td align="left" valign="top" class="col-3" style="width: 180px; padding: 0 2px;" width="180">
            <table border="0" cellpadding="0" cellspacing="0" width="176" class="activity-card" style="width: 176px; border: 1px solid #e0e6f0;" data-color="actCardBg">
              ...
              <tr><td align="left" class="card-body" style="width: 176px; padding: 16px 16px 14px 16px;" width="176">
                ...
                <p mc:edit="activity2_title" style="margin: 0 0 6px 0; font-size: 14px; font-weight: bold; font-family: Arial, sans-serif;" data-color="actTitle">Cyber Sale</p>
                <p mc:edit="activity2_desc" style="margin: 0 0 14px 0; font-size: 12px; font-family: Arial, sans-serif; line-height: 1.6;" data-color="actDesc">Exclusive online deals on IoT gateways, sensors &amp; networking gear. Limited stock &mdash; don't miss out.</p>
                ${opts.showCta !== false ? `<table border="0" cellpadding="0" cellspacing="0">
                  <tr><td style="padding: 8px 16px;" data-color="actCtaBg">
                    <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="activity2_cta" style="font-size: 11px; font-weight: bold; text-decoration: none; font-family: Arial, sans-serif;" data-color="actCtaText">Shop Now &rarr;</a>
                  </td></tr>
                </table>` : ''}
              </td></tr>
            </table>
          ...
          <td align="left" valign="top" class="col-3" style="width: 180px; padding: 0 0 0 4px;" width="180">
            <table border="0" cellpadding="0" cellspacing="0" width="176" class="activity-card" style="width: 176px; border: 1px solid #e0e6f0;" data-color="actCardBg">
              ...
              <tr><td align="left" class="card-body" style="width: 176px; padding: 16px 16px 14px 16px;" width="176">
                ...
                <p mc:edit="activity3_title" style="margin: 0 0 6px 0; font-size: 14px; font-weight: bold; font-family: Arial, sans-serif;" data-color="actTitle">AMAX Series</p>
                <p mc:edit="activity3_desc" style="margin: 0 0 14px 0; font-size: 12px; font-family: Arial, sans-serif; line-height: 1.6;" data-color="actDesc">High-performance IIoT computing platforms built for demanding industrial environments.</p>
                ${opts.showCta !== false ? `<table border="0" cellpadding="0" cellspacing="0">
                  <tr><td style="padding: 8px 16px;" data-color="actCtaBg">
                    <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="activity3_cta" style="font-size: 11px; font-weight: bold; text-decoration: none; font-family: Arial, sans-serif;" data-color="actCtaText">Learn More &rarr;</a>
                  </td></tr>
                </table>` : ''}
              </td></tr>
            </table>
  ...
  <tr><td align="center" style="padding: 0 30px 6px 30px;">
    <p mc:edit="footer_email" style="margin: 0; font-size: 11px; font-family: Arial, sans-serif; line-height: 1.6;">
  ...
  ${opts.showLegalLinks !== false ? `<tr><td align="center" style="padding: 4px 30px 8px 30px;">
    <p mc:edit="footer_legal_links" style="margin: 0; font-size: 11px; font-family: Arial, sans-serif;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center">
      <tr>
        <td align="center" style="padding: 12px 36px;" data-color="singleBtnCtaBg">
          <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="single_btn_cta" style="font-family: Arial, sans-serif; font-size: 14px; font-weight: bold; text-decoration: none;" data-color="singleBtnCtaText">Button Text &rarr;</a>
        </td>
      </tr>
    </table>
  </td></tr>
          ...
          <table border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center" style="padding: 12px 32px;" data-color="dualBtn1Bg">
                <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="dual_btn1_cta" style="font-family: Arial, sans-serif; font-size: 14px; font-weight: bold; text-decoration: none;" data-color="dualBtn1Text"><span data-color="dualBtn1Text">Primary &rarr;</span></a>
              </td>
            </tr>
          </table>
        </td>
          ...
          <table border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center" style="padding: 10px 30px;" data-border-color="dualBtn2Border" data-color="dualBtn2Bg">
                <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="dual_btn2_cta" style="font-family: Arial, sans-serif; font-size: 14px; font-weight: bold; text-decoration: none;" data-color="dualBtn2Text"><span data-color="dualBtn2Text">Secondary &rarr;</span></a>
              </td>
            </tr>
          </table>
        </td>` : ''}
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center">
      <tr>
        <td class="btn3-col" align="center" valign="middle">
          <table border="0" cellpadding="0" cellspacing="0">
            <tr><td align="center" style="padding: 10px 28px;" data-color="btn3CtaBg">
              <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="btn3_cta1" style="font-family: Arial, sans-serif; font-size: 13px; font-weight: bold; text-decoration: none;" data-color="btn3CtaText"><span data-color="btn3CtaText">Button One</span></a>
            </td></tr>
          </table>
        </td>
        ...
        <td class="btn3-col" align="center" valign="middle">
          <table border="0" cellpadding="0" cellspacing="0">
            <tr><td align="center" style="padding: 10px 28px;" data-color="btn3CtaBg">
              <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="btn3_cta2" style="font-family: Arial, sans-serif; font-size: 13px; font-weight: bold; text-decoration: none;" data-color="btn3CtaText"><span data-color="btn3CtaText">Button Two</span></a>
            </td></tr>
          </table>
        </td>
        ...
        <td class="btn3-col" align="center" valign="middle">
          <table border="0" cellpadding="0" cellspacing="0">
            <tr><td align="center" style="padding: 10px 28px;" data-color="btn3CtaBg">
              <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="btn3_cta3" style="font-family: Arial, sans-serif; font-size: 13px; font-weight: bold; text-decoration: none;" data-color="btn3CtaText"><span data-color="btn3CtaText">Button Three</span></a>
            </td></tr>
          </table>
        </td>` : ''}
      </tr>
  ...
  <tr valign="top">
    <td width="150" align="left" valign="top" class="spot-label-td"
      ...
      <p mc:edit="spot_eyebrow"
         style="margin: 0 0 10px 0; font-size: 11px; font-family: Arial, sans-serif; letter-spacing: 3px; text-transform: uppercase; font-weight: 700;" data-color="spotEyebrow">
        Spotlight
      </p>
      <h2 mc:edit="spot_title"
          style="margin: 0; font-size: 22px; font-weight: 900; font-family: Arial, sans-serif; line-height: 1.25;" data-color="spotTitle">
        ...
        <tr>
          <td style="padding: 10px 24px;" data-color="spotCtaBg">
            <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="spot_cta"
               style="font-size: 13px; font-weight: bold; text-decoration: none; font-family: Arial, sans-serif;" data-color="spotCtaText">
              View Product &rarr;
            </a>
          </td>
        </tr>
  ...
  <tr>
    <td align="center" valign="top" class="pcards-outer-td" bgcolor="#e8ecef"
      ...
      <p mc:edit="pcards_eyebrow" align="center"
         style="margin: 0 0 20px 0; font-size: 11px; font-family: Arial, sans-serif; letter-spacing: 3px; text-transform: uppercase; font-weight: 700; text-align: center;" data-color="pcardsEyebrow">
        PRODUCT PICKS
      </p>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="262" style="width: 262px;">
                    ...
                    <tr valign="top">
                      ...
                      <td style="padding: 2px 0 2px 10px;">
                        <h3 mc:edit="pcard1_title"
                            style="margin: 0; font-size: 18px; font-weight: 900; font-family: Arial, sans-serif; line-height: 1.25;" data-color="pcardsTitle">
                          ADAM-6700 Series
                        </h3>
                      </td>
                    </tr>
              ...
              <tr><td style="padding: 0 18px 14px 18px;">
                <p mc:edit="pcard1_body"
                   style="margin: 0; font-size: 12px; font-family: Arial, sans-serif; line-height: 1.4;" data-color="pcardsBody">
                  ...
                  <tr>
                    <td style="padding: 7px 18px;" data-color="pcardsCtaBg">
                      <a href="https://www.iotmart.com/s/?language=en_US" mc:edit="pcard1_cta"
                         style="font-size: 12px; font-weight: 700; text-decoration: none; font-family: Arial, sans-serif;" data-color="pcardsCtaText">
                        Shop Now &rarr;
                      </a>
                    </td>
                  </tr>
        ...
        <tr valign="top">
          ...
          <td width="382" align="left" valign="top" class="showcase-body-td" bgcolor="#ffffff"
            ...
            <p mc:edit="showcase_eyebrow"
               style="margin: 0 0 10px 0; font-size: 11px; font-family: Arial, sans-serif; letter-spacing: 3px; text-transform: uppercase; font-weight: 700;" data-color="showcaseEyebrow">
              PRODUCT CATALOG
            </p>
            <h2 mc:edit="showcase_title"
                style="margin: 0 0 10px 0; font-size: 22px; font-weight: 900; font-family: Arial, sans-serif; line-height: 1.25;" data-color="showcaseTitle">
      ...
      for (let i = 1; i <= qCount; i++) {
        ...
        if (qType === 'radio' && optArr.length) {
          optArr.forEach((opt, idx) => {
            fieldHtml += `<tr><td style="padding: 6px 0;"><label style="font-size: 13px; color: #07071a; font-family: Arial, sans-serif; cursor: pointer; display: block;"><input type="radio" name="q${i}" value="${opt.replace(/"/g, '&quot;')}" style="margin-right: 10px; accent-color: #0059ff; vertical-align: middle;" />${opt}</label></td></tr>`;
          });
        } else if (qType === 'checkbox' && optArr.length) {
          optArr.forEach((opt, idx) => {
            fieldHtml += `<tr><td style="padding: 6px 0;"><label style="font-size: 13px; color: #07071a; font-family: Arial, sans-serif; cursor: pointer; display: block;"><input type="checkbox" name="q${i}_${idx + 1}" value="${opt.replace(/"/g, '&quot;')}" style="margin-right: 10px; accent-color: #0059ff; vertical-align: middle;" />${opt}</label></td></tr>`;
          });
          ...
          fieldHtml += `<tr><td style="padding: 4px 0;"><select name="q${i}" style="width: 100%; padding: 10px 12px; font-size: 13px; font-family: Arial, sans-serif; border: 1px solid #d0d5dd; border-radius: 0; background: #fff; color: #07071a; box-sizing: border-box;"><option value="">Select...</option>${selectOptions}</select></td></tr>`;
        } else if (qType === 'text') {
          const phText = opts['q' + i + 'Placeholder'] || 'Type your answer...';
          fieldHtml += `<tr><td style="padding: 4px 0;"><input type="text" name="q${i}" placeholder="${phText.replace(/"/g, '&quot;')}" style="width: 100%; padding: 12px 14px; font-size: 13px; font-family: Arial, sans-serif; border: 1px solid #d0d5dd; border-radius: 0; background: #fff; color: #07071a; box-sizing: border-box;" /></td></tr>`;
        } else if (qType === 'textarea') {
          const phArea = opts['q' + i + 'Placeholder'] || 'Type your answer...';
          fieldHtml += `<tr><td style="padding: 4px 0;"><textarea name="q${i}" placeholder="${phArea.replace(/"/g, '&quot;')}" rows="3" style="width: 100%; padding: 12px 14px; font-size: 13px; font-family: Arial, sans-serif; border: 1px solid #d0d5dd; border-radius: 0; background: #fff; color: #07071a; box-sizing: border-box; resize: vertical;"></textarea></td></tr>`;
        } else if (qType === 'star') {
        ...
        <tr><td align="center" style="padding: ${i === 1 ? '24px' : '0'} 20px 12px 20px;">
          <table border="0" cellpadding="0" cellspacing="0" width="560" class="survey-card" style="width: 560px; max-width: 560px; background-color: #ffffff;" data-color="surveyCardBg">
            <tr><td align="left" style="padding: 20px 24px;">
              <p style="margin: 0 0 12px 0; font-size: 14px; font-weight: 700; font-family: Arial, sans-serif; color: #07071a;" data-color="surveyQuestion">Q${i}. ${qLabel}</p>
...
<table border="0" cellpadding="0" cellspacing="0" width="600" align="center" style="width:600px; background-color:#f5f7fa;" data-color="surveyOuterBg">
  <tr><td align="center" style="padding: 28px 20px 16px 20px;">
    <p style="margin: 0 0 6px 0; font-size: 12px; font-family: Arial, sans-serif; letter-spacing: 2px; text-transform: uppercase; color:#0059ff;" data-color="surveyEyebrow">${eyebrowText}</p>
    <p style="margin: 0; font-size: 22px; font-weight: 700; font-family: Arial, sans-serif; line-height: 1.3; color:#07071a;" data-color="surveyTitle">${edmTitle}</p>
  </td></tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="600" class="survey-outer" style="width: 600px; max-width: 600px;" data-color="surveyOuterBg">
  <tr><td align="center" style="padding: 28px 20px 16px 20px;" class="survey-pad">
    <p style="margin: 0 0 6px 0; font-size: 12px; font-family: Arial, sans-serif; letter-spacing: 2px; text-transform: uppercase;" data-color="surveyEyebrow">${eyebrowText}</p>
    <p style="margin: 0; font-size: 22px; font-weight: 700; font-family: Arial, sans-serif; line-height: 1.3;" data-color="surveyTitle">${edmTitle}</p>
  </td></tr>
</table>
${questionBlocks}
<table border="0" cellpadding="0" cellspacing="0" width="600" class="survey-outer" style="width: 600px; max-width: 600px;" data-color="surveyOuterBg">
  <tr><td align="center" style="padding: 16px 20px 28px 20px;">
    <button type="submit" style="padding: 12px 40px; background-color: #0059ff; color: #ffffff; font-size: 14px; font-weight: 700; font-family: Arial, sans-serif; border: none; cursor: pointer;">${submitText} →</button>
  </td></tr>
</table>
</form>
<table border="0" cellpadding="0" cellspacing="0" width="600" class="survey-outer" style="width: 600px; max-width: 600px; border-top: 1px solid #e0e6f0;" data-color="surveyOuterBg">
  <tr><td align="center" style="padding: 12px 20px;">
    <p style="margin: 0; font-size: 12px; color: #999999; font-family: Arial, sans-serif;">Can't submit? <a href="${cloudPageUrl}" style="color: #0059ff; text-decoration: underline;">Click here</a></p>
  </td></tr>
</table>
<!--<![endif]-->`;
    },
...
var RESPONSIVE_CSS = {
  ...
  'banner-v1': `
      ...
      h1.hero-v1-title { font-size: 28px !important; line-height: 1.2 !important; }
      table.split-table { width: 100% !important; }
